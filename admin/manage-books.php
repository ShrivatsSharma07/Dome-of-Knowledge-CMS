                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT id,BookName,subject,Author,Link from  tblbooks  ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="<?php echo htmlentities($result->Link);?>" Download = "<?php echo htmlentities($result->BookName);?>">Download</a></td>
